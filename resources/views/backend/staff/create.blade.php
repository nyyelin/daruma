                ...
                <form method="POST" enctype="multipart/form-data" action="{{route('staffs.store')}}">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input id="phoneno" type="number" class="form-control" name="phoneno" autofocus placeholder="Enter Phone No" value="{{ old('phoneno') }}">
                  ...
                  <div class="row">
                    ...
                    <div class="form-group col-6">
                      ...
                      <input id="designation" type="text" class="form-control" name="designation" placeholder="Enter Designation" value="{{ old('designation') }}">
                    </div>
