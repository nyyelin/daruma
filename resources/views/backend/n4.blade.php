              ...
              <div class="col-12">
                <div class="card">
                  <div class="card-header">
                      ...
                      <div class="col-lg-10 "> <h4>Japanese Level N4 Students List Table</h4></div>
                       <div class="col-lg-2 ">   
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td><a href="detail.html" class="btn btn-primary">Detail</a></td>
                          </tr>
                          <tr>
                            <td>
                              2
...
@endsection                    <div class="form-group mt-2">
                      <div class="input-group">
                        <select class="custom-select" id="inputGroupSelect05">
                          <option selected>Choose...</option>
                          <option value="1">One</option>
                      ...
                      <table class="table table-striped" id="table-1">
                        ...
                        <tbody>
                          <tr>
                            ...
                            <td>
                             <img alt="image" src="assets/img/users/user-5.png" width="35"></td>
                            </td>
                            <td> zarnihtun2435@gmail.com </td>
                            <td>
                            2020/02/09 
