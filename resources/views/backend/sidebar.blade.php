 <aside id="sidebar-wrapper">
          ...
          <ul class="sidebar-menu">
            ...
            <li class="dropdown {{ Request::is('staffs*') ? 'active' : '' }}">
              <a href="#" class="menu-toggle nav-link has-dropdown"><i data-feather="user-plus"></i><span>Staff   </span></a>
              <ul class="dropdown-menu">
            ...
            <li class="menu-header">Website Elements</li>
               ...
               <li class="dropdown {{ Request::is('slider*') ? 'active' : '' }}">
              ...
              <ul class="dropdown-menu">
                   ...
                   <li class="{{ Request::is('slider') ? 'active' : '' }}"><a class="nav-link " href="{{route('book.index')}}">Book</a></li>
            ...
            <li class="dropdown {{ Request::is('backendabout*') ? 'active' : '' }}">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="dropdown {{ Request::is('backendsubject*') ? 'active' : '' }}">
              ...
              <ul class="dropdown-menu">
                ...
                <li class="{{ Request::is('backendsubject') ? 'active' : '' }}"><a class="nav-link" href="{{route('backendreview.index')}}">Review Detail</a></li>
              </ul>
            </li>
