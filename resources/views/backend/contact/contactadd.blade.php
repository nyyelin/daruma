           ...
           <div class="col-12 col-md-6 col-lg-12">
                <div class="card">
                  ...
                  @csrf
                    ...
                    <div class="form-group col-6">
                      ...
                      <input id="phone" type="number" class="form-control" name="phone" autofocus placeholder="Enter Phone No" value="{{old('phone')}}">
                    ...
                    <div class="form-group ">
                      ...
                      <input id="map" type="text" class="form-control" name="map" autofocus placeholder="Enter a Map  Link (or) URL" value="{{old('mpap')}}">
             ...
             <div class="row">
                    <div class="form-group col-12">
                      ...
                      <textarea class="form-control" name="address" id="summernote" placeholder="Enter Address" value="{{old('address')}}"></textarea>
